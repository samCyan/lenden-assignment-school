...
class ClassRoom(models.Model):
  ...
  subjects            = models.ManyToManyField('subject.Subject', related_name='classroom_subjects')
  teachers            = models.ManyToManyField('staff.Staff', related_name='classroom_teachers')
